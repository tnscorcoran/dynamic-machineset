...
sed -i.bak -e "s/your_infrastructure_id/$infrastructure_id/g" -e "s/your_instanceType/$instanceType/g" -e "s/your_region/$region/g" -e "s/your_availabilityZone/$availabilityZone/g" "$input_file"
